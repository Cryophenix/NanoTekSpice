...
module.exports = class Component4011 extends Component {
  constructor(name) {
    let obj = {};
    for (let i = 1; i <= 14; i++) {
      obj[i] = null;
    ...
    const g1 = new BaseFactory.make["and"]("g1");
    const g2 = new BaseFactory.make["and"]("g2");
    const g3 = new BaseFactory.make["and"]("g3");
    const g4 = new BaseFactory.make["and"]("g4");
